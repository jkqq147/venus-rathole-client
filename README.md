...
The installer downloads the pinned upstream rathole release, verifies its SHA-256 checksum, installs it under `/data/venus-rathole`, and interactively asks for the client settings. No reboot is required.
